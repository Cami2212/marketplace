        ...
        fnc: function(response) {
            ...
            if (response.offer != "") {
                ...
                if (today < offerDate) {
                    ...
                    price = `<p class="ps-product__price sale">$<span class="end-price">${Number(offer).toFixed(2)}</span> <del>$${Number(response.price).toFixed(2)} </del></p>`;
                    //price = `<p class="ps-product__price">$<span class="end-price">${Number(offer).toFixed(2)}</span></p>`;
                } else {
                    price = `<p class="ps-product__price">$<span class="end-price">${Number(response.price).toFixed(2)}</span></p>`;
                }
            } else {
                price = `<p class="ps-product__price">$<span class="end-price">${Number(response.price).toFixed(2)}</span></p>`;
            }
...
export let PayPhone = {
        fnc: function(price, referenceId, phone) {
            return new Promise(resolve => {
                payphone.Button({
                    //token obtenido desde la consola de developer
                    token: "ymxosluee3Qjx_oCJ3j3HhZwbBOMS_P-o4sbZkVr1mnZPXM0koTVxnWQzZb2QQdfr9A1_9g4uarMYq-QAqTvbb7sB9r-CjedJU6ETgpmtHfR8Gpp6J1jj4F3xJMJgaELycD9ebSDw8GEhpTbLMXmxF8Vq1JrFVmts2_psyt6NSU1jHqvpikChb9gERc3O-SLLhBQULDgr1vZHw1Vevkq6rF_ji3TQkSWMhwEHcgtVo2iY8XMQBtiFMcO0ScOOOCLS_yx8tBuqFChiGoMDfnO6hoq15YwAI1QVn1Hpewy-EBXkQTzyX6UXSsE1hZkqmkqN5_7Ig",
                    ...
                    createOrder: function(actions) {
                        ...
                        return actions.prepare({
                            ...
                            currency: "USD",
                            clientTransactionId: referenceId,
                        })
                    },
