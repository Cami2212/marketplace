...
export class ProductLeftComponent implements OnInit {
  ...
  /*=============================================
	...
	=============================================*/
      ...
      Video
      =============================================*/
      if(JSON.parse(this.product[index].video)[0].lenght>0){
	...
	callback(){
		if(this.render){
            ...
            =============================================*/
			if($(".ps-product__variations").attr("specification") != "" && $(".ps-product__variations").attr("specification") != '[{\"\":[]}]'){
				/*=============================================
                Recorremos el array de objetos de detalles
                =============================================*/
				let specifications=$(".ps-product__variations").attr("specification")
				/*=============================================
                Recorremos el array de objetos de detalles
                =============================================*/
				JSON.parse(specifications as string).forEach((detail, index) => {
					/*=============================================
                    ...
                    let figure = `<figure class="details${index}">
                                    <figcaption>${property}: <strong>Selecionar Opción</strong></figcaption>
                                    <div class="d-flex">
                                    </div>
                            	</figure>`
				/*=============================================
          ...
          if(!resp){
              ...
              .subscribe(resp=>{
                  for(const i in resp){
                      ...
                      =============================================*/
                      this.messagesService.registerDatabase(this.messages, localStorage.getItem("idToken")as string)
                      .subscribe({
                        next: resp=>{
