      	...
      	.subscribe(resp=>{
	        if(Object.keys(resp).length == 0){
	        	...
	        	/*=============================================
                  ...
                  this.storeModel.products = resp[i].products;
	                /*=============================================
                ...
                =============================================*/
                this.productModel.image = `assets/img/categories/default/default-image.jpg`;
                 /*=============================================
                ...
                =============================================*/
                this.productModel.default_banner = `assets/img/categories/default/default-banner.jpg`;
                /*=============================================
                ...
                =============================================*/
                this.productModel.vertical_slider = `assets/img/categories/default/default-vertical-slider.jpg`;
                /*=============================================
                Finaliza el Preload
                =============================================*/
	        	this.preload = false;
        ...
        for(const i in allImages){
            ...
            .subscribe( resp=>{
	            ...
	            if(countAllImages == allImages.length){
	                ...
	                =============================================*/
	                this.storesService.patchDataAuth(this.idStore, this.storeModel, localStorage.getItem("idToken")as string)
	                .subscribe(resp=>{
                    ...
                    if(this.gallery.length > 0){
                        ...
                        if(this.editProductAction){
                            ...
                            for(const i in this.deleteGallery){
                                ...
                                =============================================*/
                                const formData = new FormData();
                                let fileDelete = `categories/${folder}/gallery/${this.deleteGallery[i]}`;
                                formData.append("fileDelete", fileDelete);
                                this.http.post(this.serverDelete, formData)
                                .subscribe(resp=>{})
                            }
                            ...
                            .subscribe(resp=>{
                                ...
                                if(countGallery == this.gallery.length){
                                    ...
                                    if(!this.editProductAction){
                                        ...
                                        =============================================*/
                                        this.productsService.registerDatabase(this.productModel, localStorage.getItem("idToken")as string)
                                        .subscribe(resp=>{
                                            if(resp["name"] != ""){
                                      let countProduct = this.storeModel.products
                                      countProduct++
                                      this.storeModel.products = countProduct;
                                      ...
                                      /*=============================================
                    	                Editar cantidad de Productos en la tienda
                    	                =============================================*/
                                    }else{
                                        /*=============================================
            ...
            this.products.forEach((product, index)=>{
                if(i == index){
                    allImages.push(
                        ...
                        `categories/${product.category}/default/${product.default_banner}`,
                        `categories/${product.category}/top/${product.top_banner["IMG tag"]}`,
                        `categories/${product.category}/horizontal/${product.horizontal_slider["IMG tag"]}`,
                        `categories/${product.category}/vertical/${product.vertical_slider}`
                    )
                    for(const i in product.gallery){
                        allImages.push( `categories/${product.category}/gallery/${product.gallery[i]}`);
                    }
                    for(const i in allImages){
                        /*=============================================
