		...
		if(this.render){
					...
					$(galleryMix_2[i]).append(
						`<div class="item">
	                    	<a href="assets/img/products/${$(galleryMix_1[i]).attr("category")}/gallery/${JSON.parse($(galleryMix_1[i]).attr("gallery"))[f]}">
	                    		<img loading="lazy" src="assets/img/products/${$(galleryMix_1[i]).attr("category")}/gallery/${JSON.parse($(galleryMix_1[i]).attr("gallery"))[f]}">
	                    	</a>
	                    </div>`
                    )
                    /*=============================================
          ...
          if(rating>0){
            $(review_2[i]).append(`<option value="2">${f}</option>`)
               ...
               if(f<=1){
               $(review_2[i]).append(`<option value="0">${f}</option>`)
               $(review_2[i]).append(`<option value="1">${f+1}</option>`)
               }
               else{
						   ...
						   <div class="ps-product--horizontal" style="z-index:10000">
                                <div class="ps-product__thumbnail">
                                	<a href="product/${top20Array[i][f].url}">
                                		<img loading="lazy" src="assets/img/products/${top20Array[i][f].category}/${top20Array[i][f].image}">
                                	</a>
                                </div>
